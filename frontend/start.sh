...
echo "📋 Configuration:"
echo "   API URL: ${VITE_API_URL:-http://16.170.208.132:2135}"
echo "   Port: 5173 (default)"
echo ""

# Check if backend is running
echo "🔍 Checking backend connection..."
if curl -s http://16.170.208.132:2135/health > /dev/null 2>&1; then
    echo "✅ Backend is running"
else
    echo "⚠️  Warning: Backend doesn't appear to be running on http://16.170.208.132:2135"
